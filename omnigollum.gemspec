Gem::Specification.new do |s| 
  ...
  s.homepage          = "https://github.com/chris2fr/omnigollum"
  s.email             = "chris@mann.fr"
  s.authors           = [ "Arran Cudbard-Bell", "Tenshi Hinanawi", "Chris Mann" ]
  s.licenses          = [ "MIT" ]
...
See https://github.com/chris2fr/omnigollum for usage instructions.
desc
end
